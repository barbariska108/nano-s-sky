...
# Bitcoin mainnet
<<<<<<< HEAD
DEFINES   += COIN_P2PKH_VERSION=0 COIN_P2SH_VERSION=5 COIN_FAMILY=1 COIN_COINID=\"SkyCoin\" COIN_COINID_HEADER=\"SKYCOIN\" COIN_COLOR_HDR=0xFCB653 COIN_COLOR_DB=0xFEDBA9 COIN_COINID_NAME=\"Bitcoin\" COIN_COINID_SHORT=\"SKY\" COIN_NATIVE_SEGWIT_PREFIX=\"SK\" COIN_KIND=COIN_KIND_BITCOIN 
=======
...
>>>>>>> parent of a05a65c... fixed MakeFile
...
$(error Unsupported COIN - use bitcoin_testnet, skycoin, bitcoin_cash, bitcoin_gold, litecoin, dogecoin, dash, zcash, zencash, komodo, stratis, peercoin, posw, pivx, viacoin, vertcoin, stealthcoin, digibyte, qtum, hcash, bitcoin_private)
endif
endif
